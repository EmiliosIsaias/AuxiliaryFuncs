...
block_id = [ones( sum( [size( Native_IR_lick_table, 1 ), ...
    size( Native_RS_lick_table, 1)] ) , 1, "uint8" );

    ones( sum( [size( DREADDs_IR_lick_table, 1 ), ...
    size( DREADDs_RS_lick_table, 1 ) ] ), 1, "uint8" ) + 1];
